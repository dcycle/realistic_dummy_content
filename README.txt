...
A release should be made available shortly, if it's not yet available [download the module using git](https://drupal.org/project/realistic_dummy_content/git-instructions).
