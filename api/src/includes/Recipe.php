...
abstract class Recipe {
   ...
   *
   *   use
   *   Drupal\realistic_dummy_content_api\includes\Recipe;
   *
  ...
  static public function loadRecipeClass($module) {
    ...
    if (!preg_match('/use Drupal*/s', $contents)) {
      throw new \Exception('As of the 2.x version you need to add the following line to the top of your recipe at ' . $fullpath . ': use Drupal\realistic_dummy_content_api\includes\Recipe');
    }
